...
@Named
public class DelegaciaItemWriter extends AbstractItemWriter{
	...
	public void writeItems(List<Object> items) throws Exception {
		...
		{
			RdoDelegacia rdoDelegacia = (RdoDelegacia) item;

			String json = rdoDelegaciaConverter.paraJson(rdoDelegacia);
			Client client = ClientBuilder.newClient();
		
			String servico = "http://" + host + ":"+ port + "/autenticacaobackend/rest/" + 
					"rdoDelegacia/adicionarOuAtualizar";
